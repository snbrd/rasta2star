...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from 'rasta-uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy RASTA and BNB tokens')}</li>
          ...
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your RASTA-LP tokens to buy the IFO tokens')}</li>
          </List>
