...
export default function FarmHarvest({ farmEarned, depositFee, pid, earning }: Props) {
  return (
    <div>
      <div className="row flex flex-col md:flex-col gap-5 w-full border-b-2 border-black pb-12 mb-6">
        ...
        <div className="apr bg-gray-300 w-full text-center flex flex-col rounded-lg justify-center py-3" style={{background: '#241f31',}}>
