...
// class component
const NormalClock: React.FC<ExpandableSectionProps> = ({ countdown }) => {
  ...
  return (
    <div className="NormalClock">
      ...
      <NormalUnitContainer countdown={countdown} unit="hours" digit={hour} />
      <NormalUnitContainer countdown={countdown} unit="minutes" digit={minute} />
      <NormalUnitContainer countdown={countdown} unit="seconds" digit={second} />
    </div>
  )
}
