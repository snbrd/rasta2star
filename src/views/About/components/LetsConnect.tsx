...
export default function LetsConnect({ bg, items }: Props) {
  return (
    ...
    >
      ...
      {/* <div className="max-w-screen-md mx-12 bg-white text-black px-6 mb-16 flex md:px-24 py-16 flex-col md:flex-row mt-8 md:mt-32 md:mb-0 md:mx-auto">
        <div data-aos="fade-in" data-aos-duration="1000" className="rastaFinance flex flex-col flex-grow-1 mt-8">
        ...
        <div className="lets-connect flex flex-col w-full md:w-6/12 mt-8">
          ...
          >
            <a
              ...
              className="border-2 border-green-rasta items-center text-center px-4 py py-2 rounded-xl bg-gradient-to-r hover:border-white hover:text-white hover:from-green-rasta hover:to-yellow-rasta"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <Link
              ...
              className="border-2 border-green-rasta px-4 py-2 text-center rounded-xl bg-gradient-to-r hover:border-white hover:text-white hover:from-green-rasta hover:to-yellow-rasta"
            >
