  ...
  return (
    <div>
      ...
      >
          ...
          <div className="leftSection w-full md:w-3/4 md:pl-16">
            ...
            >
              ...
              <span className="hidden md:block">
                Enjoy your Zion <br /> Experience on Web 3{/* Welcomes You to Web3.0 */}
              </span>
            ...
            <p className="mt-4 md:mt-8 text-center md:text-left" data-aos="fade-right" data-aos-duration="2000">
              ...
              ZionLabs is a creative-tech collective developing novel technologies on the blockchain; to be used within
              the music industry and beyond. Powered by the Binance Blockchain.
            </p>

            <p
              className="mt-4 md:mt-8 text-center md:text-left  break-words"
              data-aos="fade-right"
              data-aos-duration="2000"
            >
              <a
                href="https://bscscan.com/token/0xe3e8cc42da487d1116d26687856e9fb684817c52"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div
              className="cta flex flex-col md:flex-row justify-center items-center mt-8 space-y-8 md:space-y-0 md:space-x-8 md:flex"
              data-aos="fade-right"
            ...
            >
              ...
              <Link
                ...
                className="border-white border-1 p-3 md:w-1/3 text-center hover:bg-white hover:text-black"
              >
                <button type="button">Convert your Tokens</button>
              </Link>
            </div>
          </div>
        ...
        <div
          className=" w-full md:flex md:max-w-screen-xl md:mx-auto items-center md:flex-row space-x-8 my-32 md:my-20"
          style={{ display: 'none' }}
        >
